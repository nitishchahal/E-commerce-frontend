...
const APP = () => {
  ...
  return (
    <>
      ...
      <main className={!hideLayout ? "px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw]" : ""}>
        <Routes>
          ...
          <Route
            path="*"
            element={<div className="min-h-screen flex items-center justify-center"><h1 className="text-3xl">404 Not Found</h1></div>}
          />
        </Routes>
      </main>
